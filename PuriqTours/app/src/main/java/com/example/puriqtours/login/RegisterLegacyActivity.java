...
public class RegisterLegacyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_legacy_register);
        ...
        btnRegister.setOnClickListener(v -> {
            ...
            Intent i = new Intent(RegisterLegacyActivity.this, SetPasswordLegacyActivity.class);
            startActivity(i);
            finish();
        });
    }
