...
public class LoginLegacyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (localAuth.isLogged()) {
            Intent i = new Intent(LoginLegacyActivity.this, ProfileActivity.class);
        ...
        if (tvForgotPassword != null) {
            tvForgotPassword.setOnClickListener(v -> {
                Intent i = new Intent(LoginLegacyActivity.this, ForgotPasswordActivity.class);
                startActivity(i);
            });
        }
        ...
        if (tvRegister != null) {
            tvRegister.setOnClickListener(v -> {
                Intent i = new Intent(LoginLegacyActivity.this, RegisterLegacyActivity.class);
                startActivity(i);
